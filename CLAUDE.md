...
The **aw-author** Claude Code plugin (v1.3.1) at `zircote/github-agentic-workflows`. Provides skills, commands, and reference materials for GitHub Agentic Workflow (gh-aw) authoring, plus an autonomous daily intelligence pipeline.
