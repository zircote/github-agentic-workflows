...
1. Read `.claude/skills/gh-aw-report/knowledge-base.md` -- note the most recent entry date as `LAST_DATE`
2. Read `.claude/skills/gh-aw-report/references/gh-aw-architecture.md` for current known state
3. Read `.claude/skills/gh-aw-report/references/search-queries.md` for query library
4. Read `.claude/skills/aw-daily/references/tracked-repos.md` for GitHub activity query patterns
...
2. Check existing entries in `.claude/skills/gh-aw-report/knowledge-base.md` for duplicates
...
Read `.claude/skills/aw-daily/references/gap-analysis-targets.md` to load the reference file inventory.
