...
1. Read the knowledge base at `skills/gh-aw-report/knowledge-base.md` to understand the current state of knowledge
2. Read `skills/gh-aw-report/references/gh-aw-architecture.md` for stable architecture facts
3. Read `skills/gh-aw-report/references/search-queries.md` for the query library
...
Append new entries to `skills/gh-aw-report/knowledge-base.md` using the format:
